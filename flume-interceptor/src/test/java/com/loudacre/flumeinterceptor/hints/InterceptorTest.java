...
// TODO: Change 'solution' in this package name to 'hints' so that you
// test your Interceptor (it is initially set to 'solution' so that the
// code will compile).
...
public class InterceptorTest {
	...
	public void testMeeToo() throws IOException, ParseException {
		...
		// TODO write assertions to verify that the device and ambient temperature fields are correct
		
		// TODO write an assertion to verify that the battery percent field is correct
		
		// TODO write an assertion to verify that the signal percent field is correct		
		
		// TODO write an assertion to verify that the CPU load field is correct
		
		// TODO write an assertion to verify that the RAM usage field is correct
		...
		// TODO write assertions to verify that the latitude and longitude fields are correct
	}
	...
	public void testSorrento() throws IOException, ParseException {
		...
		// TODO write assertions to verify that the device name and ID fields are correct
		...
		// TODO write assertions to verify that the GPS, Bluetooth, and WiFi status fields are correct
	...
	public void testiFruit() throws IOException, ParseException {
		...
		// TODO write assertions to verify that the time field is correct
