...
public class DeviceStatusInterceptor implements Interceptor {
	...
	public Event intercept(Event event) {
		...
		// TODO: Use the fixDelta to decide if the whole number should be created
		if (true) {
		...
		// TODO: Create the string with the delimiter
		String delimitedString = "TODO";
	...
	public static class Builder implements Interceptor.Builder {
		...
		public void configure(Context context) {
			// TODO: Get the configurations
			delimiter = context.getString("TODO", "\t");
			fixDelta = context.getBoolean("TODO", true);
		}
